        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-primary mynav">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="/"><i className="fa-solid fa-house-user"></i> Aashiyana</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
...

                        {
                            loginUser && <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link to="booking" className="nav-link active"><i class="fa-solid fa-list"></i> Booking</Link>
                                </li>
